    ...
    <SafeAreaView style={[st.root, { paddingTop: insets.top }]}>
      ...
      >
        ...
        <View style={st.dividerWrap}>
          <View style={st.dividerRow}>
            ...
            <Text style={st.dividerText}>
              <Text style={st.dividerAccent}>{'∞'} </Text>
              {'124 dias juntos'}
              <Text style={st.dividerAccent}> {'∞'}</Text>
            </Text>
            <View style={st.dividerLine} />
        ...
        <Text style={[st.sectionLabel, { marginTop: 12 }]}>Mas para ustedes</Text>
                <Pressable onPress={() => Alert.alert('Función disponible pronto')}><Widget icon={<Calendar size={17} color={WHITE} />}     bg={BORDER}    title="Calendario"  sub="Fechas importantes" /></Pressable>
        <Pressable onPress={() => Alert.alert('Función disponible pronto')}><Widget icon={<Clapperboard size={17} color={WHITE} />} bg={BORDER}    title="Ver juntos"  sub="Peliculas y videos" /></Pressable>
        <Pressable onPress={() => Alert.alert('Función disponible pronto')}><Widget icon={<Flame size={17} color={WHITE} />}        bg={BORDER}    title="Actividades" sub="Ideas para hacer juntos" /></Pressable>
